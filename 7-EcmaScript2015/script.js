...
const allParks = [new Park('Green Park', 1987, 0.2, 215),
                 new Park('National Park', 1894, 2.9, 3555),
                 new Park('Oak Park', 1953, 0.4, 950)];
const allStreets = [new Street('a', 1999, 1.1, 4),
                  new Street('b', 2008, 2.7, 2),
                  new Street('c', 2015, 0.8),
                  new Street('d', 1982, 2.5, 5)];
